/***************************************************************************
  ...
  Email:
    ...
    - j.mullarkey6@universityofgalway.ie
...
const float P0 = 1013.25; // Standard pressure at sea level in Hectopascals
...
float calcAltitude(float temperature, float pressure){
  ...
  float altitude = (((P0 / pressure) ^ (1 / 5.257) - 1) * (temperature + 273.15))/0.0065;
  return altitude;
}
